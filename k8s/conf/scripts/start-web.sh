...
printf "\n\033[1;1mChecking and creating data directory\033[0m\n\n"

mkdir -p /efs/data
chown nobody:nobody /efs/data

printf "\n\033[1;1mCopying in muc config file\033[0m\n\n"

mkdir -p /efs/data/muc
cp /src/muc.config.php /efs/data/muc/config.php
chown nobody:nobody /efs/data/muc/config.php
